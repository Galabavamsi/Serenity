        ...
        child: Center(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Container(
                  child: const Text('"Feeling stressed? Take a break and relax with a calming game designed to ease your mind and lift your spirits"',
                    style: TextStyle(
                    fontFamily: 'SecondFont',
                      fontSize: 25
                  ),
                ...
                CustomOutlinedButton(onPressed: (){
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context){
                    return const BubblePopGameScreen();
                  }));
                }, data: 'Start a game',),
              ],
            ),
