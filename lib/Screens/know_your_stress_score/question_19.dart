...
import 'package:serenity_app/Screens/know_your_stress_score/question_20.dart';
...
class _Question19State extends State<Question19> {
  ...
  void _navigateToNextQuestion(BuildContext context, int rating) {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const Question20()),
    );
  }
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: LinearProgressIndicator(
                      value: 0.905, // Representing progress (190%)
                      color: Colors.pink,
