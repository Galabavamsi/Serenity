...
import 'package:serenity_app/Screens/know_your_stress_score/question_17.dart';
...
class _Question16State extends State<Question16> {
  ...
  void _navigateToNextQuestion(BuildContext context, int rating) {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const Question17()),
    );
  }
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: LinearProgressIndicator(
                      value: 0.762, // Representing progress (160%)
                      color: Colors.pink,
