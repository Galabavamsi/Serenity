...
import 'package:serenity_app/Screens/know_your_stress_score/question_21.dart';
...
class _Question20State extends State<Question20> {
  ...
  void _navigateToNextQuestion(BuildContext context, int rating) {
    ...
    Provider.of<StressCalculator>(context, listen: false).addRating(rating, 'a');

    // Navigate to the next question
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const Question21()),
    );
  }
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: LinearProgressIndicator(
                      value: 0.952, // Representing progress (200%)
                      color: Colors.pink,
