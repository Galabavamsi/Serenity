...
import 'package:serenity_app/Screens/know_your_stress_score/question_9.dart';
...
class Question8 extends StatefulWidget {
  ...
  @override
  State<Question8> createState() => _Question4State();
}

class _Question4State extends State<Question8> {
  int? selectedOption;

  void _navigateToNextQuestion(BuildContext context, int rating) {
    // Save the selected rating
    Provider.of<StressCalculator>(context, listen: false).addRating(rating, 's');
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: LinearProgressIndicator(
                      value: 0.381, // Representing progress (40%)
                      color: Colors.pink,
