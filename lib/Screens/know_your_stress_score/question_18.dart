...
import 'package:serenity_app/Screens/know_your_stress_score/question_19.dart';
...
class _Question18State extends State<Question18> {
  ...
  void _navigateToNextQuestion(BuildContext context, int rating) {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const Question19()),
    );
  }
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: LinearProgressIndicator(
                      value: 0.857, // Representing progress (180%)
                      color: Colors.pink,
