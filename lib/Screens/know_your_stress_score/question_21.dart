...
class _Question21State extends State<Question21> {
  ...
  void _navigateToResultScreen(BuildContext context, int rating) {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: LinearProgressIndicator(
                      value: 1, // Representing progress (210%)
                      color: Colors.pink,
                  ...
                  ...List.generate(
                    4,
                      ...
                      child: GestureDetector(
                        onTap: () {
                          // On selecting an option, navigate to the result screen
                          _navigateToResultScreen(context, index);
                        },
